...
export default function Media() {
  ...
  const images = adminData.gallery?.length > 0 ? adminData.gallery : demoImages;
  ...
  return (
    <div className="min-h-screen pb-16 pt-28">
      <div className="container-custom">
        ...
        <p className="mb-10 text-center text-gray-500">{t('Tumanimiz hayotidan foto va videolar', 'Фото и видео из жизни нашего района')}</p>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {images.map((img, idx) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 flex items-end justify-center pb-4 transition duration-300 opacity-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent group-hover:opacity-100">
                <p className="font-semibold text-white">{t(img.title, img.titleRu)}</p>
              </div>
