...
export default function MediaUpload({ onUploadComplete, multiple = false, accept = 'image/*,audio/*,video/*,application/pdf' }) {
      ...
      try {
        ...
        if (response.data.success) {
          setFiles(prev => prev.map(f => 
            f.id === fileItem.id ? { ...f, status: 'success', url: response.data.file.url } : f
          ));
